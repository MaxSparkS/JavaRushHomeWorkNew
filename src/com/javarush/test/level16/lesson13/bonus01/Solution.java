...
1. Внимательно посмотри, какие классы у тебя есть.(done)
2. В отдельных файлах в пакете common создай классы JpgReader, PngReader, BmpReader, которые реализуют интерфейс ImageReader.(done)
